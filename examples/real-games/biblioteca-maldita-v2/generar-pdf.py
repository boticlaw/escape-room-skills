...
if __name__ == "__main__":
    ...
    cmd = [
        ...
        "--directorio", "juegos/biblioteca-maldita-v2",
        "--nombre", "La Biblioteca Maldita",
        "--subtitulo", "El bibliotecario dejó un libro abierto. Nunca debisteis leerlo.",
        "--color", "#5C4033",
        "--color-sec", "#D4AF37",
        "--autor", "Escapeitor",
        "--plantilla", "juegos/biblioteca-maldita-v2/plantilla.typ",
